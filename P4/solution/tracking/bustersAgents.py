    ...
    def chooseAction(self, gameState):
        ...
        for i in range(len(livingGhostPositionDistributions)):
                ...
                for p in livingGhostPositionDistributions[i].sortedKeys():
                    if livingGhostPositionDistributions[i][p] > livingGhostPositionDistributions[i][guess]:
                        guess = p
        ...
        for action in legal:
            ...
            if self.distancer.getDistance(target[0], successorPosition) < self.distancer.getDistance(target[0], pacmanPosition):
